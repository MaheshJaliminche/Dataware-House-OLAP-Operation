...
<html lang="en">
<head>
<title>DATA WAREHOUSE | Query2</title>
<meta charset="utf-8">
	...
	<div id="wrap">
		...
		<div id="main">
			<div id="contact-details">
				...
				<% 
				// java.util.ArrayList;
				java.util.ArrayList<String> arrq2= new java.util.ArrayList<String>();
				arrq2= BAL.Stats.query2();
				
				
				out.println("<div id=\"menu\" style=\"height:510px;width:740px;;border:2px;float:left;\">");
				out.println("<b>QUERY :List the types of Drug which have been applied to patient with 'tumor')</b><br>");
