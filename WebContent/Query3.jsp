...
<html lang="en">
<head>
<title>DATA WAREHOUSE | Query3</title>
<meta charset="utf-8">
	...
	<div id="wrap">
		...
		<div id="main">
			<div id="contact-details">
				...
				<% 
				// java.util.ArrayList;
				java.util.ArrayList<Integer> arrq3= new java.util.ArrayList<Integer>();
				arrq3= BAL.Stats.query3();
				String qr= "for each sample of patient with 'ALL', list the mRNA expression values of probe in custer+"
						+ " id '00002' for each experiment with measure unit id='001'."; 
