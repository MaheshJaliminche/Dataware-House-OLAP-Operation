...
<html lang="en">
<head>
<title>DATA WAREHOUSE | Quer61</title>
<meta charset="utf-8">
	...
	<div id="wrap">
		...
		<div id="main">
			<div id="contact-details">
				...
				String qr= "For probes belonging to GO with id='0007154', calculate average correlation of the expression values "
						+ "between two patient with 'ALL', and calculate the average correlation of the expression values between one 'ALL' and one 'AML' "; 
				...
				out.println("<b>ALL - ALL  : "+d[0]+"</b><br>");
				out.println("<b>ALL - AML : "+d[1]+"</b><br>");
				out.println("</div>");	
				out.println("</div>");
				%>
